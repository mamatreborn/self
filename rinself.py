...
#ririn = LINE("")
ririn = LINE("EubW9M9I5t075bLNdIkf.evdUJ4DYeg3N0pIIxcv73W.OnvMHdxg4ciQJW7fsbYD6Bts9CiUeogOm+WhwgloeZc=")
...
def ririnBot(op):
    try:
        ...
        if op.type == 5:
            ...
            ririn.sendMessage(op.param1, "✪ᴄɪᴇᴇ ᴊᴏɴᴇs ɴɢᴇ ᴀᴅᴅ 😂✪")
        ...
        if op.type == 15:
        	dan = ririn.getContact(op.param2)
        	tgb = ririn.getGroup(op.param1)
        	ririn.sendMessage(op.param1, "ɴᴀʜ ᴋᴀɴ ʙᴀᴘᴇʀ 「{}」, ᴜᴅᴀʜ sᴏɴᴏ ᴘᴇʀɢɪ... 😒 ɢᴀᴋ ᴜsᴀʜ ᴏɴ ʟᴀɢɪ ᴅɪ.. {}  \nʜᴀᴘᴜs ᴀᴋᴜɴ sᴇᴋᴀʟɪᴀɴ ! ᴛʀᴜs ᴄᴇʟᴜᴘɪɴ ᴛᴜʜ ʜᴘ ᴋᴇ ᴇᴍʙᴇʀ !! ʙᴇʀᴇss !!! 😒😒".format(str(dan.displayName),str(tgb.name)))
        	ririn.sendContact(op.param1, op.param2)
        	ririn.sendImageWithURL(op.param1, "http://dl.profile.line-cdn.net{}".format(dan.picturePath))
        	#=============SAMBUTAN FOR STICKER==========#        
        if op.type == 17:
                    ...
                    if msg_id in msg_dict:
                        if msg_dict[msg_id]["from"]:
                            ...
                            if contact.displayNameOverridden != None:
                                ...
                                ret_ += "\nsᴇɴᴅᴇʀ : @!      "
                                ret_ += "\nsᴇɴᴅ  : ".format(str(dt_to_str(cTime_to_datetime(msg_dict[msg_id]["createdTime"]))))
